...
const validator = require("validator"); //for custom validation on tourname
...
const tourSchema = new mongoose.Schema({
  name: {
    ...
    validate: [validator.isAlpha, "Tour name must only contain characters"], //custom validator using validator library.
  },
  slug: String,
  duration: {
    type: Number,
  ...
  priceDiscount: {
    type: Number,
    validate: {
      //custom validator is a simple function (not arrow as we use this.price) which returns true or false.
